...
from DarlingRobot.services.keyboard import Ikb
from DarlingRobot.utils.pluginhelper import convert_seconds_to_minutes as time_convert, fetch
from DarlingRobot.services.tasks import _get_tasks_text, all_tasks, rm_task
from DarlingRobot.services.types import InlineQueryResultCachedDocument
from DarlingRobot.modules.info import get_chat_info, get_user_info
from DarlingRobot.utils.functions import test_speedtest
from DarlingRobot.utils.pastebin import paste
    ...
    answerss = [
        InlineQueryResultArticle(
            ...
            input_message_content=InputTextMessageContent(
                "**__✘ Click A Button To Get Started. ✘__**"
            ),
            thumb_url="https://telegra.ph/file/901568df19f4bbb43f277.jpg",
...
async def alive_function(answers):
    ...
    buttons.add(
        InlineKeyboardButton("✘ Main bot ✘", url="https://t.me/ZeroXDarlingbot"),
        InlineKeyboardButton(
    ...
    msg = f"""
**[Darling Robot 💖](https://t.me/Zerotwoxsupport):**
**MainBot:** `{bot_state}`
**UserBot:** `{ubot_state}`
...
**Profiles:** [BOT](t.me/{BOT_USERNAME}) | [OWNER BOT](t.me/X_Hate)
"""
    answers.append(
        InlineQueryResultArticle(
            title="Alive",
            description="Check Bot's Stats",
            thumb_url="https://telegra.ph/file/ac806039532c4f789e36f.jpg",
            input_message_content=InputTextMessageContent(
