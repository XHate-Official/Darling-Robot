...
from DarlingRobot import pbot as app, BOT_ID
from DarlingRobot.utils.errors import capture_err
from DarlingRobot.utils.permissions import adminsOnly
from DarlingRobot.ex_plugins.dbfunctions import (
    alpha_to_int,
    get_karma,
    get_karmas,
    int_to_alpha,
...
regex_upvote = r"^((?i)\+|\+\+|\+1|thx|thanx|thanks|pro|noice|piro|thmx|thamx|thamks|Op|Nice|cool|good|👍)$"
regex_downvote = r"^(\-|\-\-|\-1|👎|noob|nub|bhak|noobde|jnl|weak)$"
