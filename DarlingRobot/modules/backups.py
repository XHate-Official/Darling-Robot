...
import DarlingRobot.modules.sql.notes_sql as sql
from DarlingRobot import dispatcher, LOGGER, OWNER_ID, JOIN_LOGGER, SUPPORT_CHAT
from DarlingRobot.__main__ import DATA_IMPORT
...
# from DarlingRobot.modules.rules import get_rules
import DarlingRobot.modules.sql.rules_sql as rulessql

# from DarlingRobot.modules.sql import warns_sql as warnssql
import DarlingRobot.modules.sql.blacklist_sql as blacklistsql
from DarlingRobot.modules.sql import disable_sql as disabledsql

# from DarlingRobot.modules.sql import cust_filters_sql as filtersql
# import DarlingRobot.modules.sql.welcome_sql as welcsql
import DarlingRobot.modules.sql.locks_sql as locksql
from DarlingRobot.modules.connection import connected
...
def export_data(update, context):
    ...
    context.bot.sendDocument(
        current_chat_id,
        document=open("DarlingXRobot{}.backup".format(chat_id), "rb"),
        caption="*Successfully Exported backup:*\nChat: `{}`\nChat ID: `{}`\nOn: `{}`\n\nNote: This `DarlingXRobot-Backup` was specially made for notes.".format(
            chat.title,
            chat_id,
            tgl,
        ),
    ...
    os.remove("DarlingXRobot{}.backup".format(chat_id))  # Cleaning file
