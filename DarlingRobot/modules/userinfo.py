...
def info(update: Update, context: CallbackContext):
    ...
    rep = message.reply_text("<code>Let's see what you've got..</code>", parse_mode=ParseMode.HTML)
    ...
    if user.id == OWNER_ID:
        text += "\n\n♡ This User is My Darling and only Mine ♡."
        disaster_level_present = True
    elif user.id in DEV_USERS:
        text += "\n\n✧ This user is one of Council Members."
        disaster_level_present = True
    elif user.id in DRAGONS:
        text += "\n\n✦ The Disaster level of this person is 'Mayor'."
        disaster_level_present = True
    elif user.id in DEMONS:
        text += "\n\n✧ This user is one of the 9's."
        disaster_level_present = True
    elif user.id in TIGERS:
        text += "\n\n✦ OwO, This User is Special To Me."
        disaster_level_present = True
    elif user.id in WOLVES:
        text += "\n\n✧ The Disaster level of this person is 'Commander'."
        disaster_level_present = True
    elif user.id == 5115385926:
         text += "\n\n×͜× Owner Of Noob Bot. King Of Owner."
         disaster_level_present = True
                    ...
                    [
                        [
                            InlineKeyboardButton(
                                "✘ Health ✘", url="https://t.me/ZeroTwoXUpdates/4"),
                            InlineKeyboardButton(
                                "✘ Disaster ✘", url="https://t.me/ZeroTwoXUpdates/5"),
        ...
        update.effective_message.reply_text(
            (
                (
                    ...
                    + f"\n\n✦ [Support](https://t.me/ZeroTwoXSupport) | ✦ [Updates](http://t.me/ZeroTwoXUpdates)\n\n"
                )
                + "╘══「 Powered By [Enmu](https://t.me/ZeroXDarlingBot) | [Darling](http://t.me/X_hate)」\n"
            ),
            parse_mode=ParseMode.MARKDOWN,
            disable_web_page_preview=True,
        )
...
def set_about_bio(update: Update, context: CallbackContext):
    ...
    if message.reply_to_message:
        ...
        if user_id == bot.id and sender_id not in DEV_USERS:
            message.reply_text(
                "Ba...Ka..., I only trust My Darling to set my bio.",
            )
            return
