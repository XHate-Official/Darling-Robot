...
from DarlingRobot import TIGERS, WOLVES, dispatcher
...
from DarlingRobot.modules.sql import antiflood_sql as sql
...
def check_flood(update, context) -> str:
    ...
    try:
        ...
        if getmode == 1:
            ...
            execstrings = "Good Job! Banned for {}".format(getvalue)
            tag = "TBAN"
        elif getmode == 5:
            ...
            execstrings = "Congrats! Muted for {}".format(getvalue)
            tag = "TMUTE"
        send_message(
