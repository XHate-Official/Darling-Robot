...
import DarlingRobot.modules.sql.global_bans_sql as gban_sql
import DarlingRobot.modules.sql.users_sql as user_sql
from DarlingRobot import DEV_USERS, OWNER_ID, dispatcher
