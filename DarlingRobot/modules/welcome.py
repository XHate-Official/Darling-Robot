        ...
        if should_welc:
            ...
            if new_mem.id == OWNER_ID:
                update.effective_message.reply_photo(
                    DARLING_IMG,
                    caption="OwO!!! My Darling Just Joined this group",
                    reply_to_message_id=reply,
                )
                welcome_log = (
            ...
            # Welcome Devs
                ...
                update.effective_message.reply_photo(
                    COUNCIL_IMG,
                    caption="Be Cool! A Council Minister Just Joined.",
                    reply_to_message_id=reply,
                )
                welcome_log = (
                    f"{html.escape(chat.title)}\n"
            ...
            # Welcome Sudos
                ...
                update.effective_message.reply_photo(
                    MAYOR_IMG,
                    caption="Shhhhh!!!!!! A User with Mayor Disaster Just Joined. Be carefull",
                    reply_to_message_id=reply,
                )
                welcome_log = (
                    f"{html.escape(chat.title)}\n"
