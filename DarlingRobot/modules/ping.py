...
from DarlingRobot.modules.sudoers import bot_sys_stats
...
from DarlingRobot import StartTime, dispatcher, pgram
...
PING_IMG = "https://telegra.ph/file/bad814879ec8449f3e067.jpg"
    ...
    update.effective_message.reply_photo(
        ...
        parse_mode=ParseMode.HTML,
            reply_markup=InlineKeyboardMarkup(
                [
                  [
                  InlineKeyboardButton(text="• sᴏᴍᴇᴏɴᴇ •", url="https://t.me/x_hate")
                  ]
                ]
            ),
        )
