...
from .helper_funcs.decorators import darlingcmd, darlingcallback
...
@darlingcmd(command="raid", pass_args=True)
@bot_admin
@connection_status
@loggable
...
@darlingcallback(pattern="enable_raid=")
@connection_status
@user_admin_no_reply
@loggable
...
@darlingcallback(pattern="disable_raid=")
@connection_status
@user_admin_no_reply
@loggable
...
@darlingcallback(pattern="cancel_raid=")
@connection_status
@user_admin_no_reply
...
@darlingcmd(command="raidactiontime", pass_args=True)
@connection_status
@user_admin(AdminPerms.CAN_CHANGE_INFO)
@loggable
def raidtime(update: Update, context: CallbackContext) -> Optional[str]:
