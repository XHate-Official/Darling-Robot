...
from DarlingRobot import DRAGONS, dispatcher
...
from DarlingRobot.modules.helper_funcs.admin_rights import user_can_changeinfo, user_can_promote
...
def fullpromote(update: Update, context: CallbackContext) -> str:
    ...
    if user_id == bot.id:
        message.reply_text("I can't promote myself! Get an admin to do it for me. Will ya?")
        return
